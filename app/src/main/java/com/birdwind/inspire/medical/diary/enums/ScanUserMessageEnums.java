...
public enum ScanUserMessageEnums {
    IS_DOCTOR("此人身分為醫生", "301"), IS_FAMILY("此人身分為家屬", "302"), IS_PAINTER("此人身分為病人", "303"), DOCTOR_ALREADY_ADD_PAINTER(
        "已在病人名單裡", "201"), HAVE_ANOTHER_DOCTOR("此病人已經有其他醫生負責", "201"), HAVE_DOCTOR("已經有負責的醫生", "001"), ADD_TO_PAINTER(
            "是否要加為自己的病人", "400"), ADD_TO_FAMILY("是否要加為自己的家屬", "401"), ADD_TO_DOCTOR("是否要加為自己的醫生", "402");
    private String key;
