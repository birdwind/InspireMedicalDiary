...
public class Builder {
     ...
     */
    public CustomIndicatorSeekBar build() {
        return new CustomIndicatorSeekBar(this);
    }
    ...
    /**
     * Set the enable limit of this seek bar's range.
     *
     * @param value the enable max range
     * @return Builder
     */
    public Builder enableValue(float value) {
        if (max <= value) {
     ...
     *
     * @param showIndicatorType see{@link IndicatorType} IndicatorType.NONE; IndicatorType.CIRCULAR_BUBBLE;
     *        IndicatorType.ROUNDED_RECTANGLE; IndicatorType.RECTANGLE; IndicatorType.CUSTOM;
     * @return Builder
     */
    ...
    /**
     * set the seek bar's indicator's custom top content view. no effect on custom and circular_bubble indicator type.
     *
    ...
    /**
     * set the seek bar's indicator's custom top content view layout identify. no effect on custom and circular_bubble
     * indicator type.
     *
     ...
     * @return Builder selector format like:
     */
    ...
    // <?xml version="1.0" encoding="utf-8"?>
    // <selector xmlns:android="http://schemas.android.com/apk/res/android">
    // <item android:drawable="Your drawableA" android:state_pressed="true" /> <!--this drawable is for thumb when
    // pressing-->
     ...
     *
     * @param tickCount the tickMarks count show on seek bar. if you want the seek bar's block size is N , this
     *        tickCount should be N+1.
     * @return Builder
     */
     ...
     *
     * @param tickMarksType see{@link TickMarkType} TickMarkType.NONE; TickMarkType.OVAL; TickMarkType.SQUARE;
    ...
    /**
     * set the seek bar's tick width , if tick type is divider, call this method will be not worked(tick type is
     * divider,has a regular value 2dp).
     *
    ...
    // <?xml version="1.0" encoding="utf-8"?>
    // <selector xmlns:android="http://schemas.android.com/apk/res/android">
    // <item android:drawable="@mipmap/ic_launcher_round" android:state_pressed="true" /> <!--this drawable is for thumb
    // when pressing-->
