...
public class FriendAdapter extends BaseQuickAdapter<FriendResponse.Response, BaseViewHolder> {
    public FriendAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(@NotNull BaseViewHolder baseViewHolder, FriendResponse.Response response) {
