...
public class RecordVoiceDialogPresenter extends AbstractPresenter<RecordVoiceDialogView> {
    public RecordVoiceDialogPresenter(RecordVoiceDialogView baseView) {
        super(baseView);
    }
