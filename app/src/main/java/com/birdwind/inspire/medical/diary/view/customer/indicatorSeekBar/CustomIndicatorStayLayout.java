 ...
 */
public class CustomIndicatorStayLayout extends LinearLayout {

    public CustomIndicatorStayLayout(Context context) {
        this(context, null);
    }

    public CustomIndicatorStayLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomIndicatorStayLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public void attachTo(CustomIndicatorSeekBar seekBar) {
        attachTo(seekBar, -2);
    }
     ...
     */
    public void attachTo(CustomIndicatorSeekBar seekBar, int index) {
        if (seekBar == null) {
    ...
    private void layoutIndicator(View child, int index) {
        if (child instanceof CustomIndicatorSeekBar) {
            CustomIndicatorSeekBar seekBar = (CustomIndicatorSeekBar) child;
            ...
            if (contentView instanceof CustomIndicatorSeekBar) {
