...
import com.birdwind.inspire.medical.diary.model.request.SurveyAnswerRequest2;
...
public class SurveyPresenter2 extends AbstractPresenter<SurveyView> {
    public SurveyPresenter2(SurveyView baseView) {
        super(baseView);
    }
    ...
    public void submit(SurveyAnswerRequest2 surveyAnswerRequest) {
        initMap();
        addDisposable(
