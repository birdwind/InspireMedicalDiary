...
public class GroupMemberAdapter extends BaseQuickAdapter<ChatMemberModel, BaseViewHolder> {
    public GroupMemberAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder baseViewHolder, ChatMemberModel response) {
