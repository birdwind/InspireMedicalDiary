...
public class ShowHidePasswordEditText extends AppCompatEditText implements TextWatcher {
    ...
    public ShowHidePasswordEditText(@NonNull @NotNull Context context) {
        super(context);
        init(null);
    }

    public ShowHidePasswordEditText(@NonNull @NotNull Context context, @Nullable @org.jetbrains.annotations.Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public ShowHidePasswordEditText(@NonNull @NotNull Context context, @Nullable @org.jetbrains.annotations.Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            visibilityIndicatorShow = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_show, R.drawable.ic_eye_show);
            visibilityIndicatorHide = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_hide, R.drawable.ic_eye_hide);
            ...
            visibilityIndicatorShow = R.drawable.ic_eye_show;
            visibilityIndicatorHide = R.drawable.ic_eye_hide;
