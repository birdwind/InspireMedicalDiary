...
import com.birdwind.init.base.view.loadingDialog.view.CustomView;
...
public final class LoadingCustom extends LoadingBaseDialog {
            ...
            if (mCustomView == null) {
                ...
                if (mBuilder.mType == RESOURCE_TYPE) {
                    ...
                    for (int i = 0; i < mResourceCount; i++) {
                        mBitmaps.add(
                            BitmapFactory.decodeResource(mBuilder.mContext.getResources(), mBuilder.mResources.get(i)));
                    }
                } else {
