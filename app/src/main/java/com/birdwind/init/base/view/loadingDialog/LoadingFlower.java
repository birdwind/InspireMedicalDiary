package com.birdwind.init.base.view.loadingDialog;

import com.birdwind.init.R;
import com.birdwind.init.base.view.loadingDialog.view.FlowerView;
...
public class LoadingFlower extends LoadingBaseDialog {
    ...
    public void show() {
        if (mFlowerView == null) {
            ...
            mFlowerView = new FlowerView(mBuilder.mContext, size, mBuilder.mBackgroundColor, mBuilder.mBackgroundAlpha,
                mBuilder.mBackgroundCornerRadius, mBuilder.mPetalThickness, mBuilder.mPetalCount, mBuilder.mPetalAlpha,
                mBuilder.mBorderPadding, mBuilder.mCenterPadding, mBuilder.mThemeColor, mBuilder.mFadeColor,
                mBuilder.mText, mBuilder.mTextSize, mBuilder.mTextColor, mBuilder.mTextAlpha, mBuilder.mTextMarginTop,
                mBuilder.mTextExpandWidth);
        }
