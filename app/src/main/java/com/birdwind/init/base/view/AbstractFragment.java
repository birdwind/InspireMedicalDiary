...
import com.birdwind.init.base.basic.BaseView;
import com.birdwind.init.base.enums.ErrorCodeEnums;
import com.birdwind.init.base.utils.LogUtils;
import com.birdwind.init.base.utils.SharedPreferencesUtils;
import com.birdwind.init.base.utils.ToastUtils;
import com.birdwind.init.base.utils.analytics.FirebaseAnalyticUtils;
import com.birdwind.init.base.utils.fragmentNavUtils.FragmentNavigationListener;
import com.birdwind.init.base.view.loadingDialog.LoadingBaseDialog;
import com.birdwind.init.base.view.loadingDialog.LoadingConstant;
import com.birdwind.init.base.view.loadingDialog.LoadingFlower;
import com.birdwind.init.presenter.AbstractPresenter;
import com.birdwind.init.view.activity.BottomNavigationActivity;
import com.birdwind.init.view.activity.WebViewActivity;
...
//            ((BottomNavigationActivity) context).getIconBadges();
    ...
    public void onServerShutDown() {
        showDialog(context.getString(R.string.dialog_error_title), getString(R.string.error_common_server_shutdown),
    ...
    public void showFunctionNotComplete(boolean isNeedBake) {
        showDialog(getString(R.string.dialog_title), getString(R.string.function_not_complete),
            new CommonDialogListener() {
                @Override
                public void clickConfirm() {
                    if (isNeedBake) {
