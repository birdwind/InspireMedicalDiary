...
public class BottomNavigationIndicatorView extends BottomNavigationIndicatorViewInner {
    public BottomNavigationIndicatorView(Context context) {
        super(context);
    }

    public BottomNavigationIndicatorView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BottomNavigationIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
